...
# 
# grm <- read.delim("/Users/slacksa/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Collabs/metaboxcan/data/gcta/CG10k_NHW_hg19_Oct2017_filt_maf0.05_grm.grm.bin")
# 
...
# }
# 
# grm <- ReadGRMBin("/Users/slacksa/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Collabs/metaboxcan/data/gcta/CG10k_NHW_hg19_Oct2017_filt_maf0.05_grm")
```
...
of performance in females vs. males. Using Pearson correlation.
...
plot_pub(acc_c1_sub_f, acc_c1_sub_m, "2. Covar Full, Subset 953")
plot_pub(acc_c2_f, acc_c2_m, "3. Covar Only Age and Sex, Subset 953")
```
